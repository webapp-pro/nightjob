...
class AdminController extends Controller
{
    public function dashboard()
    {
        ...
        return view('account.dashboard')->with([
            ...
            'occupationCategories' => OccupationCategory::all(),
            'businessCategories' => BusinessCategory::all(),
            'specialityCategories' => SpecialityCategory::all(),
            'dashCount' => $dashCount,
    ...
    {
        $users = User::select('id', 'name', 'birthday', 'telephone', 'email', 'created_at')->latest()->paginate(30);
